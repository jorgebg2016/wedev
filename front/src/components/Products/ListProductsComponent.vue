...
<template>
    <div class="table-products p-3 p-0 col-sm-12 d-flex justify-content-center row">
        <div v-if="askConfirm" 
            ...
            <div>
                <button class="btn text-white btn-secondary mr-2" type="button"
                    v-on:click="askConfirm=false; product=null">
                    Cancel
                </button>
        ...
        <div class="p-0 m-0 pr-2 d-flex col-sm-10 justify-content-end">
            <div>
                <a href="/products/create" type="button"
                    ...
                    <plus-icon size="1.0x" class="custom-class mr-2"></plus-icon>Add Product
                </a>
            </div>
        </div>
        <div class="m-1 p-2 mt-2 col-sm-10">
            <table v-if="sortedProducts.length > 0" 
                ...
                <thead class="table-bordered">
                    <tr>
                        ...
                        <th scope="col" class="head" @click="sort('description')">Description</th>
                        <th scope="col" class="head" @click="sort('amount')">Initial Amount</th>
                        <th scope="col" class="head" @click="sort('current_amount')">Current Amount</th>
                        <th scope="col" class="head" @click="sort('price')">Price</th>
                ...
                <tbody class="table-bordered">
                    <tr v-for="product in sortedProducts" :key="product.id">
                        ...
                        <td>$ {{ product.price }}</td>
                        <td>
                            <a :href="'/products/'+product.id+'/details'" type="button" 
                            ...
                            <button type="button" 
                                ...
                                v-on:click="askConfirmDelete(product)">
            ...
            <div class="card p-2" v-if="sortedProducts.length == 0">
                No product stored yet.
            </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            askConfirmDelete(product) { 
                this.askConfirm = true
                this.product = product
            },
            confirmDelete() {
                store.dispatch({ type: 'deleteProduct', productID: this.product.id })
